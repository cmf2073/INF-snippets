<VirtualHost *:80>
	...
	#RewriteRule ^/web/api/private/subscriptors/(.*)$ http://claroviajes.com/web/api/private/subscriptors/$1 [R=302,L]
	...
	SetOutputFilter INFLATE;proxy-html;DEFLATE
   	...
   	<Proxy *>
        ...
        ErrorLog /var/log/apache2/mx-aws.claroviajes.com_errors.log
        LogLevel notice
        CustomLog /var/log/apache2/mx-aws.claroviajes.com_access.log dev
